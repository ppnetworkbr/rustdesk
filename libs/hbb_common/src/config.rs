...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("PPDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remotedesk.ppnetwork.com.br"];
pub const PUBLIC_RS_PUB_KEY: &str = "EekoxEYIl4m6Jvt1ZM7TrsdL236qdaMmW32SGRNbSoI=";
